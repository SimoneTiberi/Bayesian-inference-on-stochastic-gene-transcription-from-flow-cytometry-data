...
# Compute the average of the observations in each replicate:
mu_Y_Tet5  = sapply(Y_5, mean)
mu_Y_Tet10 = sapply(Y_10, mean)
avg = c(mean(mu_Y_Tet5), mean(mu_Y_Tet10))

library(xtable)
xtable( rbind( cbind(mu_Y_Tet5, mu_Y_Tet10), avg), digits = 0)
